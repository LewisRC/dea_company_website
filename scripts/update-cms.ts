  ...
  const casesData = [
    {
      ...
      titleEn: 'Meishan Mindong Care Center, Sichuan - Smart Elderly Care Model',
      description: '为四川眉山岷东养护中心构建"全时守护，智享康养"一体化解决方案，深度融合智能监测、健康管理与应急响应系统，覆盖生活照料、安全监护、健康关怀等场景，打造安全、舒适、智能的现代康养生活新标杆。',
      descriptionEn: 'Built an integrated "24/7 Care, Smart Living" solution for Meishan Mindong Care Center, deeply integrating intelligent monitoring, health management and emergency response systems, covering daily care, safety monitoring, and health care scenarios, creating a new benchmark for safe, comfortable and intelligent modern elderly care.',
      image: '/images/case/case1.jpg',
      badge: null,
      badgeEn: null,
      tags: '["智慧康养", "智能监测", "安全监护", "健康管理", "应急响"]',
      tagsEn: '["Smart Elderly Care", "Intelligent Monitoring", "Safety Care", "Health Management", "Emergency Response"]',
      order: 1,
      isActive: true
    },
    {
      ...
      descriptionEn: 'Comprehensive deployment of smart hospital systems, achieving intelligent TCM-featured diagnosis and treatment, efficient medical-nursing collaboration, automated logistics and distribution, and fully digitalized patient services throughout the entire process, significantly improving medical quality and operational efficiency.',
      image: '/images/case/case2.jpg',
      badge: null,
      badgeEn: null,
      tags: '["中医智能化", "医护对讲", "智能物流", "数字化服务"]',
      tagsEn: '["TCM Intelligentization", "Medical Intercom", "Smart Logistics", "Digital Services"]',
      order: 2,
      isActive: true
    },
    {
      ...
      titleEn: 'Zhangbei Maternal & Child Health Hospital, Hebei - Smart New Campus Foundation',
      description: '为张北妇幼保健院异地新建项目构建全院智慧化平台，融合前沿信息基础设施与妇幼专科业务，打造覆盖楼宇、病房及远程服务的整合方案，树立县域妇幼健康服务数字化新标杆。',
      descriptionEn: 'Built a hospital-wide smart platform for Zhangbei MCH Hospital relocation and new construction project, integrating cutting-edge information infrastructure with maternal and child health specialized services, creating an integrated solution covering building, wards and remote services, establishing a new benchmark for digitalized county-level MCH services.',
      image: '/images/case/case3.jpg',
      badge: null,
      badgeEn: null,
      tags: '["智慧妇幼", "新院建设", "专科信息化", "远程医疗", "智慧病房"]',
      tagsEn: '["Smart MCH", "New Campus Construction", "Specialized Informatization", "Telemedicine", "Smart Ward"]',
      order: 3,
      isActive: true
    },
    {
