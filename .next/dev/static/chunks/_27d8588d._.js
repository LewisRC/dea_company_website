...
"[project]/components/sections/carousel-section.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CarouselSection() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CarouselSection.useEffect": ()=>{
            const checkMobile = {
                "CarouselSection.useEffect.checkMobile": ()=>{
            ...
            return ({
                "CarouselSection.useEffect": ()=>window.removeEventListener('resize', checkMobile)
            })["CarouselSection.useEffect"];
        }
    }["CarouselSection.useEffect"], []);
    // 从API加载轮播图数据
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CarouselSection.useEffect": ()=>{
            const fetchCarousels = {
                "CarouselSection.useEffect.fetchCarousels": async ()=>{
                    try {
            ...
            }["CarouselSection.useEffect.fetchCarousels"];
            fetchCarousels();
        }
    }["CarouselSection.useEffect"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CarouselSection.useEffect": ()=>{
            ...
            const interval = setInterval({
                "CarouselSection.useEffect.interval": ()=>{
                    setCurrentSlide({
                        "CarouselSection.useEffect.interval": (prev)=>(prev + 1) % totalSlides
                    }["CarouselSection.useEffect.interval"]);
                }
            }["CarouselSection.useEffect.interval"], 5000) // 5秒切换一次
            ;
            return ({
                "CarouselSection.useEffect": ()=>clearInterval(interval)
            })["CarouselSection.useEffect"];
        }
    }["CarouselSection.useEffect"], [
        isAutoPlay,
...
_s(CarouselSection, "rsKPyXPj5/jHfnpWEERgrPcrYEw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useI18n"]
    ];
});
...
"[project]/components/sections/solutions-section.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SolutionsSection() {
    _s();
    const solutions = __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$site$2d$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["siteConfig"].solutions || [];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SolutionsSection.useEffect": ()=>{
            const handleResize = {
                "SolutionsSection.useEffect.handleResize": ()=>{
                    setIsMobile(window.innerWidth < 768);
                }
            }["SolutionsSection.useEffect.handleResize"];
            window.addEventListener('resize', handleResize);
            handleResize(); // 设置初始值
            return ({
                "SolutionsSection.useEffect": ()=>window.removeEventListener('resize', handleResize)
            })["SolutionsSection.useEffect"];
        }
    }["SolutionsSection.useEffect"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
...
_s(SolutionsSection, "zZ5gfaxk5iXSrc4vqUuD6APXH18=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useI18n"]
    ];
});
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PageLoader.useEffect": ()=>{
            const timer1 = setTimeout({
                "PageLoader.useEffect.timer1": ()=>{
                    setIsFading(true);
                }
            }["PageLoader.useEffect.timer1"], 800);
            const timer2 = setTimeout({
                "PageLoader.useEffect.timer2": ()=>{
                    setIsLoading(false);
                }
            }["PageLoader.useEffect.timer2"], 1300);
            return ({
                "PageLoader.useEffect": ()=>{
                    clearTimeout(timer1);
                    clearTimeout(timer2);
...
_s(PageLoader, "5qnPborU8mE/A3H0PMk1bBx7k48=");
_c = PageLoader;
var _c;
...
function useScrollAnimation() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useScrollAnimation.useEffect": ()=>{
            const handleScroll = {
                "useScrollAnimation.useEffect.handleScroll": ()=>{
                    ...
                    animatedElements.forEach({
                        "useScrollAnimation.useEffect.handleScroll": (element)=>{
            ...
            window.addEventListener('scroll', handleScroll);
            return ({
                "useScrollAnimation.useEffect": ()=>window.removeEventListener('scroll', handleScroll)
            })["useScrollAnimation.useEffect"];
        }
    }["useScrollAnimation.useEffect"], []);
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$sections$2f$carousel$2d$section$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/sections/carousel-section.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$sections$2f$solutions$2d$section$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/sections/solutions-section.tsx [app-client] (ecmascript)");
...
function Home() {
    ...
    // 滚动动画
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$scroll$2d$animation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useScrollAnimation"])();
    // 为 sections 添加滚动动画类
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$page$2d$loader$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PageLoader"], {}, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$sections$2f$carousel$2d$section$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CarouselSection"], {}, void 0, false, {
                        fileName: "[project]/app/page.tsx",
                        lineNumber: 38,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$sections$2f$solutions$2d$section$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SolutionsSection"], {}, void 0, false, {
                        fileName: "[project]/app/page.tsx",
                        lineNumber: 39,
                        columnNumber: 9
                    }, this)
...
_s(Home, "gWVbWsu/XytfTAinsKiKSTABV/0=", false, function() {
    return [
...
//# sourceMappingURL=_27d8588d._.js.map